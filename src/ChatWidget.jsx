...
/* Header */
.evc__head{display:flex;align-items:center;justify-content:space-between;padding:16px 18px;border-bottom:1px solid rgba(125,220,200,0.08);flex-shrink:0}
...
/* Messages */
.evc__msgs{flex:1;overflow-y:auto;padding:18px 16px;display:flex;flex-direction:column;gap:12px;scrollbar-width:thin;scrollbar-color:rgba(125,220,200,0.12) transparent}
.evc__msgs::-webkit-scrollbar{width:4px}
.evc__msgs::-webkit-scrollbar-thumb{background:rgba(125,220,200,0.15);border-radius:2px}
...
.evc__msg--a{align-self:flex-start;background:rgba(125,220,200,0.07);border:1px solid rgba(125,220,200,0.1);color:rgba(255,255,255,0.75);border-radius:2px 12px 12px 2px}
.evc__msg--u{align-self:flex-end;background:rgba(78,205,180,0.18);border:1px solid rgba(78,205,180,0.25);color:rgba(255,255,255,0.88);border-radius:12px 2px 2px 12px}
@keyframes evcFadeIn{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}

/* Typing indicator */
.evc__typing{align-self:flex-start;display:flex;gap:4px;padding:12px 16px;background:rgba(125,220,200,0.05);border:1px solid rgba(125,220,200,0.08);border-radius:2px 12px 12px 2px;animation:evcFadeIn 0.3s ${EASE}}
.evc__typing span{width:6px;height:6px;border-radius:50%;background:rgba(125,220,200,0.35);animation:evcBounce 1.4s ease-in-out infinite}
...
/* Input */
.evc__input{display:flex;align-items:center;gap:8px;padding:12px 14px;border-top:1px solid rgba(125,220,200,0.08);flex-shrink:0;background:rgba(0,0,0,0.2)}
...
.evc__qbtn{font-size:11px;padding:6px 12px;border:1px solid rgba(125,220,200,0.15);background:rgba(125,220,200,0.04);color:rgba(255,255,255,0.5);cursor:pointer;transition:all 0.3s;border-radius:99px;white-space:nowrap;font-family:inherit}
.evc__qbtn:hover{border-color:rgba(78,205,180,0.5);color:var(--ac2,#7DDCC8);background:rgba(78,205,180,0.08)}
